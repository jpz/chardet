...
from .langarabicmodel import (CP864_ARABIC_MODEL, CP720_ARABIC_MODEL,
                              ISO_8859_6_ARABIC_MODEL,
                              WINDOWS_1256_ARABIC_MODEL)
from .langbelarusianmodel import (IBM866_BELARUSIAN_MODEL, ISO_8859_5_BELARUSIAN_MODEL,
                                  MACCYRILLIC_BELARUSIAN_MODEL,
                                  WINDOWS_1251_BELARUSIAN_MODEL)
from .langbulgarianmodel import (IBM855_BULGARIAN_MODEL,
                                 ISO_8859_5_BULGARIAN_MODEL,
                                 WINDOWS_1251_BULGARIAN_MODEL)
from .langcroatianmodel import (ISO_8859_2_CROATIAN_MODEL,
                                WINDOWS_1250_CROATIAN_MODEL)
from .langczechmodel import ISO_8859_2_CZECH_MODEL, WINDOWS_1250_CZECH_MODEL
from .langdanishmodel import (ISO_8859_1_DANISH_MODEL, ISO_8859_15_DANISH_MODEL,
                              WINDOWS_1252_DANISH_MODEL)
from .langdutchmodel import ISO_8859_1_DUTCH_MODEL, WINDOWS_1252_DUTCH_MODEL
from .langenglishmodel import (ISO_8859_1_ENGLISH_MODEL,
                               WINDOWS_1252_ENGLISH_MODEL)
from .langesperantomodel import ISO_8859_3_ESPERANTO_MODEL
from .langestonianmodel import (ISO_8859_4_ESTONIAN_MODEL,
                                ISO_8859_13_ESTONIAN_MODEL,
                                WINDOWS_1257_ESTONIAN_MODEL)
from .langfinnishmodel import (ISO_8859_1_FINNISH_MODEL,
                               ISO_8859_15_FINNISH_MODEL,
                               WINDOWS_1252_FINNISH_MODEL)
from .langfrenchmodel import (ISO_8859_1_FRENCH_MODEL, ISO_8859_15_FRENCH_MODEL,
...
from .langitalianmodel import (ISO_8859_1_ITALIAN_MODEL,
                               ISO_8859_15_ITALIAN_MODEL,
                               WINDOWS_1252_ITALIAN_MODEL)
from .langlatvianmodel import (ISO_8859_4_LATVIAN_MODEL,
                               ISO_8859_13_LATVIAN_MODEL,
                               WINDOWS_1257_LATVIAN_MODEL)
from .langlithuanianmodel import (ISO_8859_4_LITHUANIAN_MODEL,
                                  ISO_8859_13_LITHUANIAN_MODEL,
                                  WINDOWS_1257_LITHUANIAN_MODEL)
from .langmacedonianmodel import (IBM855_MACEDONIAN_MODEL,
...
from .langportuguesemodel import (ISO_8859_1_PORTUGUESE_MODEL,
                                  ISO_8859_15_PORTUGUESE_MODEL,
                                  WINDOWS_1252_PORTUGUESE_MODEL)
from .langromanianmodel import (ISO_8859_2_ROMANIAN_MODEL,
...
from .langserbianmodel import (IBM855_SERBIAN_MODEL, ISO_8859_5_SERBIAN_MODEL,
...
from .langslovenemodel import (ISO_8859_2_SLOVENE_MODEL,
                               WINDOWS_1250_SLOVENE_MODEL)
from .langspanishmodel import (ISO_8859_1_SPANISH_MODEL,
                               ISO_8859_15_SPANISH_MODEL,
                               WINDOWS_1252_SPANISH_MODEL)
from .langthaimodel import (CP874_THAI_MODEL, ISO_8859_11_THAI_MODEL,
                            TIS_620_THAI_MODEL)
from .langturkishmodel import (ISO_8859_3_TURKISH_MODEL,
...
class SBCSGroupProber(CharSetGroupProber):
    def __init__(self):
        ...
        # # TODO: See if using ISO-8859-8 Hebrew model works better here, since it's actually the visual one
